...
#         performance_pred, engagement_pred, outliers = learning_path_supervised(
#             reduced_integrated, merged_df
#         )
#
...
#     st.session_state["groups"] = groups         # learning paths
...
#     #         st.write(action)
#
#     st.session_state['reduced_integrated'] = reduced_integrated     # pca is applied to X_integrated to get reduced_integrated
